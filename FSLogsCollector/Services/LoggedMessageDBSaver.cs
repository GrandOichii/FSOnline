...
public class LoggedMessageDBSaver(ILogger<LoggedMessageDBSaver> logger) : ILoggedMessageProcessor {
    private readonly ILogger<LoggedMessageDBSaver> _logger = logger;
