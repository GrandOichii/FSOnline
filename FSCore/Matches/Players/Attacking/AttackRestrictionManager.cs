...
public class AttackRestrictionManager
{
    ...
    public List<IAttackRestriction> Restrictions { get; }

    public AttackRestrictionManager(Player player)
    {
        _player = player;
    ...
    public bool CanPass()
    {
        return _player.AttackOpportunities.Count() == 0 || Restrictions.Count == 0;
    }
    ...
    //     public StateT(AttackRestrictionManager parent)
    //     {
